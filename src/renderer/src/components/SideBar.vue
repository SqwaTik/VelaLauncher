...
.nav-link::before {
  ...
  box-shadow: 0 0 12px rgba(118, 104, 255, 0.5);
...
.instance-link.active {
  color: var(--text-0);
  background: rgba(118, 104, 255, 0.09);
}
...
.instance-avatar {
  ...
  color: var(--text-2);
  background:
    radial-gradient(circle at 35% 25%, #2a3150, #15192a 70%);
  border: 1px solid var(--hairline-strong);
  transition:
...
.nav-link.active .nav-icon {
  color: var(--green);
  background: rgba(118, 104, 255, 0.11);
}
.nav-copy b {
  color: inherit;
  font-size: 13px;
...
.create-primary {
  color: #f7f5ff;
  background: var(--green);
  box-shadow: 0 8px 24px rgba(118, 104, 255, 0.22);
}
.instance-icon-editor {
  position: relative;
  overflow: visible;
