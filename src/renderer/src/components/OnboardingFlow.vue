...
import logo from "@/assets/images/royale-logo-transparent.png";
        ...
        <main>
          <Transition name="tour-step" mode="out-in">
            <div v-if="step === 0" key="welcome" class="tour-page">
              ...
              <h1>Здравствуйте, это Royale Launcher</h1>
              <p>
                Royale собирает игру, профили и настройки в одном спокойном
            ...
            <div v-else-if="step === 2" key="java" class="tour-page">
              ...
              <p>
                ...
                версии нет, Royale загрузит её в собственную папку автоматически
