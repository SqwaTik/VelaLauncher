...
await check("bundle installs Vela 0.1.4 and IAS 26.2 and repairs modified bytes",async()=>{
 ...
 assert(jars.some(name=>name.includes("vela-client-0.1.4")));assert(jars.includes("IAS-9.0.7+26.2-fabric.jar"));
