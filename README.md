...
Настольный лаунчер Vela для Minecraft `26.2` и Fabric на Electron, Vue 3 и TypeScript.

## Возможности

- установка Minecraft 26.2, Fabric Loader, Fabric API, Java 25 и Vela Client с подробным прогрессом;
...
В лаунчере доступны локальные профили, Ely.by и LittleSkin. Microsoft-аккаунты добавляются во встроенном Vela Account Manager; авторизацию, шифрованное хранение и смену сессии обеспечивает In-Game Account Switcher 9.0.7.
...
Игровые файлы и настройки хранятся в пользовательском каталоге `.vela`; они не входят в репозиторий.
